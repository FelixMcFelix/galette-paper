...
def main():
	...
	for machine, uxdp_time in zip(machines, uxdp_p_times):
		with open(out_template.format(machine, ""), "w") as of:
			build_outfile(machine, of, excl_szs=["128", "256", "512", "1024", "1280", "1518"])

		with open(out_template.format(machine, "-upcall"), "w") as of:
			build_outfile(machine, of, p_dir=uxdp_p_dir.format(uxdp_time), excl_rates=["0.5", "50"], excl_szs=["128", "256", "512", "1024", "1280", "1518"])
