...
set ylabel "Traffic Processing Rate (Kernel-XDP, RPi) (\\unit{\\mega\\bit\\per\\second})"
...
file(i) = sprintf("../results/2022-11-29/t-summary-%sM-kxdp-rpi", Rates[i + 1])

plot for [i=0:5] file(i) u 1:2 with linespoints title myTitle(i) ls LineStyles[i + 1] dt DashStyles[i + 1]#, \
