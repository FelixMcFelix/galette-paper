...
array SrcFiles[2]
SrcFiles[1] = "../results/SUMMARY/kern-vs-user-nuc/2023-01-05T09.50.11+00.00/nuc/tru-kxdp-0.5p-1ms/l-summary-%sM.csv"
SrcFiles[2] = "../results/SUMMARY/kern-vs-user-nuc/2023-01-05T09.50.11+00.00/nuc/tru-uxdp-0.5p-1ms/l-summary-%sM.csv"

array Titles[2]
Titles[1] = "\\textsc{Gal}---XDP"
Titles[2] = "\\textsc{Gal}---\\texttt{AF\\_XDP}"
