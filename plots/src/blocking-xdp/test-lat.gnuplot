...
plot for [i=0:3] file(i) u 1:(1.0e-3 * $4) every 42::(1 + 14 + 7 * (i % 2)) with linespoints title myTitle(i) ls (i) dt DashStyles[(i % 2) + 1], \
	for [i=0:3] file(i) u 1:(1.0e-3 * $5) every 42::(1 + 14 + 7 * (i % 2)) with linespoints title myTitle2(i) ls (i + 4) dt DashStyles[(i % 2) + 1]